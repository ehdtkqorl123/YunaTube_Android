 ...
 */
public class SquareBezelImageView extends SquareImageView {
    ...
    public SquareBezelImageView(Context context) {
        this(context, null);
    }

    public SquareBezelImageView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SquareBezelImageView(Context context, AttributeSet attrs, int defStyle) {
