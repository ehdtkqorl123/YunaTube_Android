	...
	protected void onLayout(boolean changed, int l, int t, int r, int b) {
		...
		switch (mExpandDirection) {
			...
			case EXPAND_DOWN:
				...
				mAddButton.layout(maxWidth - mAddButton.getMeasuredWidth(), addButtonY, maxWidth, addButtonY + mAddButton.getMeasuredHeight());

				int nextY = expandUp ?
						addButtonY - mButtonSpacing :
						addButtonY + mAddButton.getMeasuredHeight() + mButtonSpacing;

				int paddingX = (mAddButton.getMeasuredWidth() - ResourceUtil.getDimensionInPx(R.dimen.fab_size_mini)) / 4;
				...
				for (int i = getChildCount() - 1; i >= 0; i--) {
					...
					int childX = maxWidth - child.getMeasuredWidth();
					int childY = expandUp ? nextY - child.getMeasuredHeight() : nextY;
					child.layout(childX - paddingX, childY, maxWidth - paddingX, childY + child.getMeasuredHeight());
