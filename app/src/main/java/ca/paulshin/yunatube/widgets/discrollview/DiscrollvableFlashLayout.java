 ...
 *
 */
public class DiscrollvableFlashLayout extends LinearLayout implements Discrollvable {
    ...
    public DiscrollvableFlashLayout(Context context) {
        super(context);
    }

    public DiscrollvableFlashLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public DiscrollvableFlashLayout(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void onFinishInflate() {
        ...
        mGreenColor = getResources().getColor(R.color.yellow);
    }
