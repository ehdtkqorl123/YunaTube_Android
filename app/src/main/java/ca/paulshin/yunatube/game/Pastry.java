...
public class Pastry {
	...
	public void update() {
		...
		//
		// game_pastry move from right to left
		//
		...
		//
		// if game_pastry beyond left hand side of display then disable it
		//
		if (x < -w) {
			alive = false;
		}
	...
	public void draw(Canvas canvas) {
		canvas.drawBitmap(game.pastryImage, rect.left, rect.top, game.backgroundPaint);
	}
