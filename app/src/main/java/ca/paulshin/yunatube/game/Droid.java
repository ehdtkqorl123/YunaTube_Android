...
class Droid {
	...
	public void update() {
		...
		//
		// first: handle collision detection with game_pastry and potholes
		//		
	...
	public void draw(Canvas canvas) {
		...
		if (jumping || falling) {
			canvas.drawBitmap(game.droidJumpImage, x, y, game.backgroundPaint);
		}
		else {
			canvas.drawBitmap(game.charImages[curFrame], x, y, game.backgroundPaint);
		}
	...
	private void doCollisionDetection() {
		...
		//
		// check for game_pastry collision
		//
		rect.left = x;
		rect.top = y;
		rect.bottom = y + h;
